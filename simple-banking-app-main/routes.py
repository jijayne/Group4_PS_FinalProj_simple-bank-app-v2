...
from urllib.parse import urlparse  # Correct replacement
from app import app, csrf
from extensions import db, limiter
from forms import (
    LoginForm, RegistrationForm, TransferForm, ResetPasswordRequestForm,
    ResetPasswordForm, DepositForm, UserEditForm, ConfirmTransferForm
)
...
def login():
    ...
    if form.validate_on_submit():
        ...
        # Check for old SHA-256 password hash (64 chars, no bcrypt prefix)
        ...
        # Check user status and roles before allowing login
